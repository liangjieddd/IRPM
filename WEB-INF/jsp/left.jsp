...
<body>
	<div style="margin:15px;background-color: #F3F3F3; text-align:left;">
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr><td height="2"></td></tr>
		   ...
		   <tr valign="top"><td height="100%" align="center"><div class="copycct"><br /><strong></strong><br><strong>Copyright © 2018 Your Site. All rights reserved.</strong><br><br>Designed by <strong>董靓杰</strong>（2014006241）<br><br>太原理工大学-软件学院-软件工程-1425班/毕业设计</div></td></tr>
