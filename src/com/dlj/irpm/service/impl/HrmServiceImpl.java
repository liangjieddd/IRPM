...
import com.dlj.irpm.dao.DeptDao;
import com.dlj.irpm.dao.DocumentDao;
import com.dlj.irpm.dao.EmployeeDao;
import com.dlj.irpm.dao.JobDao;
import com.dlj.irpm.dao.NoticeDao;
import com.dlj.irpm.dao.UserDao;
import com.dlj.irpm.domain.Dept;
import com.dlj.irpm.domain.Document;
import com.dlj.irpm.domain.Employee;
import com.dlj.irpm.domain.Job;
import com.dlj.irpm.domain.Notice;
import com.dlj.irpm.domain.UserDetail;
import com.dlj.irpm.service.HrmService;
...
public class HrmServiceImpl implements HrmService{
	...
	@Override
	public UserDetail login(String loginname, String password) {
//		System.out.println("HrmServiceImpl login -- >>");
	...
	@Transactional(readOnly=true)
	@Override
	public List<UserDetail> findUser(UserDetail user,PageModel pageModel) {
		/** 当前需要分页的总数据条数  */
		...
		List<UserDetail> users = userDao.selectByPage(params);
	...
	@Transactional(readOnly=true)
	@Override
	public UserDetail findUserById(Integer id) {
	 ...
	 * */
	@Override
	public void modifyUser(UserDetail user) {
		userDao.update(user);
