...
import static com.dlj.irpm.util.common.HrmConstants.EMPLOYEETABLE;
...
import com.dlj.irpm.dao.provider.EmployeeDynaSqlProvider;
...
public interface EmployeeDao {
	...
	@Results({
		...
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="com.dlj.irpm.dao.DeptDao.selectById",
		fetchType=FetchType.EAGER)),
		@Result(column="JOB_ID",property="job",
			one=@One(select="com.dlj.irpm.dao.JobDao.selectById",
		fetchType=FetchType.EAGER))
	})
